...
<div class="container">
    ...
    <?php 
        ...
        $result =  $con->getPDO()->query("SELECT * FROM Uzivatele WHERE Role='student'");
        ...
        while(($row = $result->fetch())):?>
            <tr>
                ...
                <td><a class="btn edit-btn" href="studentList.php?edit=<?php echo $row['Id_uzivatel'] ?>">Editace</a></td>
                <td><a class="btn delete-btn" href="studentList.php?delete=<?php echo $row['Id_uzivatel'] ?>">Odebirat</a></td>
                <!--<td><a class="btn subject-btn" href="studentList.php?predmety=<?php// echo $row['Id_uzivatel'] ?>">Predmety</a></td>-->
            </tr>
    <?php endwhile;?>
        </table>
    </div>
